...
public class TestInvoice extends AbstractAccountingPrintTest<Invoice, InvoicePosition> {
  ...
  public static Function<Integer, Consumer<InvoicePosition>> createPosition =
      i -> invoicePosition("spaceholder " + i, bd(100).add(bd(i)), bd(100).add(bd(i)), "13");
  ...
  protected Invoice getFullInvoice() {
    return createAccountingPrint(compose(buyer, seller, basicData), printBaseData, positions());
  }
